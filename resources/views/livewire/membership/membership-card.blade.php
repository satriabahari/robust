...
<div class="dark:bg-neutral-800 text-center flex flex-col">
    <div class="space-y-1 bg-red-500 p-4 text-neutral-50">
    ...
    <div class="p-4 space-y-2 bg-white flex flex-col items-center">
        ...
        <h1 class="text-red-500 font-bold lg:text-4xl text-3xl">Rp {{ $price }} <span
                class="text-neutral-900 text-sm">/mth</span></h1>
        <p class="text-sm font-bold dark:text-neutral-50 py-2 border-t border-neutral-900">Access</p>
        <h3 class="font-bold dark:text-neutral-50">Home Club Cibubur Junction</h3>
        <p class="dark:text-neutral-50">{{ $description }}</p>
        <p class="text-sm font-bold dark:text-neutral-50 py-2 border-t border-neutral-900">Commitment Length</p>
        <div class="mb-4">
            @foreach ($durations as $month)
                <p class="dark:text-neutral-50">{{ $month }} Month{{ $month > 1 ? 's' : '' }}</p>
            @endforeach
        </div>
