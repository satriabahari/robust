<x-container isFullScreen class="grid grid-cols-2 pt-16 gap-x-8 items-center justify-center">
    <div class="bg-red-600 h-full">
        <img src="{{ '/images/gym.png' }}" alt="gym" height="20">
    </div>
    <div class="text-center space-y-8">
        <h3 class="text-neutral-700 dark:text-neutral-200 font-semibold text-4xl">Join Online</h3>
        <form wire:submit="save" class="flex flex-col gap-4 " action="{{ route('join-online.store') }}" method="POST">
            ...
            <button type="submit" class="bg-red-600 text-neutral-50 rounded-lg py-2 px-4 hover:bg-red-700 transition duration-300 active:scale-95">Join</button>
        </form>
    </div>
</x-container>
